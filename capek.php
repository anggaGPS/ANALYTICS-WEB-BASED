...
<link href="css.css" rel="stylesheet" type="text/css" />
        ...
        <td align="left" valign="top" style="background-image:url(images/index_02a.gif); background-repeat:repeat-x; padding-top:2px;"><table width="780" height="20" border="0" cellspacing="0" cellpadding="0">
          <tr>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td align="center" valign="top"><a href="?page=home"><img src="images/Book.png" width="34" height="30" alt="?page=hometd>
              </tr>
            </table>
			</td>

            <td width="2" align="center" valign="top"><img src="images/index_02b.gif" alt="" width="2" height="46td>
            <td width="130" align="center" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td align="center" valign="top" class="menu"><a href="?page=data-ujian">Data Ujian</a></td>
              </tr>
              <tr>
                <td align="center" valign="top"><a href="?page=data-ujian"><img src="images/Clipboard.png" width="36" height="30" alt="?page=data-bencanatd>
              </tr>
            </table>
			</td>
            ...
            <td width="130" align="center" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td align="center" valign="top"><a href="?page=data-provinsi"><img src="images/Compas.png" width="36" height="30" alt="?page=data-provinsitd>
              </tr>
            </table>
			</td>
            ...
            <td width="130" align="center" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td align="center" valign="top" class="menu"><a href="?page=info-target">Info Target</a></td>
              </tr>
              <tr>
                <td align="center" valign="top"><a href="?page=info-target"><img src="images/Compas.png" width="36" height="30" alt="?page=info-targettd>
              </tr>
            </table>
			</td>
            ...
            <td width="130" align="center" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td align="center" valign="top" class="menu"><a href="?page=lokasi">Lokasi Ujian</a></td>
              </tr>
              <tr>
                <td align="center" valign="top"><a href="?page=data-lokasi"><img src="images/Compas.png" width="36" height="30" alt="?page=lokasitd>
              </tr>
            </table>
			</td>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td align="center" valign="top" class="menu"><a href="?page=info-ujian">Input Data</a></td>
              </tr>
              <tr>
                <td align="center" valign="top"><a href="?page=info-ujian"><img src="images/Watches.png" width="36" height="30" alt="?page=info-bencanatd>
              </tr>
            </table>
			</td>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td align="center" valign="top"><a href="?page=statistik"><a href="?page=statistik"><img src="images/Infinity-Loop.png" width="36" height="30" alt="?page=statistiktd>
              </tr>
            </table>
			</td>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td align="center" valign="top" class="menu"><a href="?page=peta28">Peta</a></td>
              </tr>
              <tr>
                <td align="center" valign="top"><a href="modul/?page=isi_gmaps"><img src="images/Retina-Ready.png" width="36" height="30" alt="?page=peta28td>
              </tr>
            </table>
			</td>
			<td width="2" align="center" valign="top"><img src="images/index_02b.gif" alt="" width="2" height="46td>
      ...
      <tr>
        <td align="left" valign="top">
            <div style="float:left; width:780px;">
              <div style="float:left; width:489px;"><img src="images/index_29.png" alt="" width="780" height="100" border="0" usemap="#Mapdiv>
  ...
  <tr>
    <td align="left" valign="top" style="padding-top:15px;"><table width="780" border="0" cellspacing="0" cellpadding="0" style="background-image:url(images/index_02b.gif); background-repeat:repeat-x;">
	  ...
	  <div style="float:left; width:780px;">
              <div style="float:left; width:489px;"><img src="images/footer.png" alt="" width="780" height="5" border="0" usemap="#Mapdiv>
    ...
    <!-- AdminLTE App -->
    <script src="diapp.min.js" type="text/javascript"></script>
    <!-- AdminLTE for demo purposes -->
    <script src="didemo.js" type="text/javascript"></script>
    <!-- page script -->
