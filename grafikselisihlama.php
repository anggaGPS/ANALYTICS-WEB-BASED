...
<form action="?page=grafikselisihlama" method="post" name="postform">
...
echo"<SCRIPT LANGUAGE='Javascript' SRC='FusionCharts/FusionCharts.js'></SCRIPT>";
 ...
 $strXML="<graph caption='Grafik Selisih Target' numberPrefix='  ' yAxisName='peserta' decimalPrecision='0' formatNumberScale='0'>";
	...
	$sql="SELECT * FROM view_analisis where provinsi like '%$provinsi%' and tahun between '$tahun_awal' and '$tahun_akhir'"; $qr=mysql_query($sql); while($Data=mysql_fetch_array($qr)){
...
$kategori .= "</categories>";
   ...
   $strXML .= "</graph>";
   echo renderChart("FusionCharts/FCF_StackedBar2D.swf", "", $strXML, "productSales", 1225, 350);
