        ...
        <div class="login-screen">
          ...
          <div class="login-form">
            <div class="form-group">
              <input type="text" class="form-control login-field" value="" placeholder="NIP" name="nip" />
			...
			<td valign="top"><input class="btn btn-primary btn-lg btn-block"  type="submit" value="Login"> </a>
		</tr>
            <a class="login-link" href="daftar.php">Daftar</a>
          </div>
        </div>
      </div>
</form>	
