...
<form action="?page=grafikujianlama" method="post" name="postform">
            ...
            <div class="col-xs-12">
              <div class="box">
                <div class="box-header">
                  <h3 class="box-title">Data Pejualan Pin per Ujian</h3>
<div class="box-body">
...
echo"<SCRIPT LANGUAGE='Javascript' SRC='FusionCharts/FusionCharts.js'></SCRIPT>";
 ...
 $strXML="<graph caption='Grafik Selisih Target' numberPrefix='  ' yAxisName='peserta' decimalPrecision='0' formatNumberScale='0'>";
	...
	$sql="SELECT * FROM total_ujian where nama_ujian like '%$nama_ujian%' and tahun between '$tahun_awal' and '$tahun_akhir' "; $qr=mysql_query($sql); while($Data=mysql_fetch_array($qr)){
   
   	$arrData[3][4]="$Data[nama_ujian]";
