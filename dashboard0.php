        ...
        <td align="left" valign="top" style="background-image:url(images/index_02a.gif); background-repeat:repeat-x; padding-top:2px;"><table width="780" height="20" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <td width="130" align="center" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td align="center" valign="top"><a href="?page=data-ujian"><img src="images/Clipboard.png" width="36" height="30" alt="?page=data-bencana" /></td>
              </tr>
            </table>
			</td>
            ...
            <td width="130" align="center" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td align="center" valign="top"><a href="?page=info-target"><img src="images/Compas.png" width="36" height="30" alt="?page=info-target" /></td>
              </tr>
            </table>
			</td>
            ...
            <td width="130" align="center" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td align="center" valign="top"><a href="?page=data-lokasi"><img src="images/Compas.png" width="36" height="30" alt="?page=lokasi" /></td>
              </tr>
            </table>
			</td>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td align="center" valign="top"><a href="?page=info-ujian"><img src="images/Watches.png" width="36" height="30" alt="?page=info-bencana" /></td>
              </tr>
            </table>
			</td>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td align="center" valign="top"><a href="modul/?page=isi_gmaps"><img src="images/Retina-Ready.png" width="36" height="30" alt="?page=peta28" /></td>
              </tr>
            </table>
			</td>
			<td width="2" align="center" valign="top"><img src="images/index_02b.gif" alt="" width="2" height="46" /></td>
